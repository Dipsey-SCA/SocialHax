...
echo "		#####################################################"
echo "		#                                                   #"
echo "		#          SOCIALHAX - Brute Force Method           #"
echo "		#                                                   #"
echo -e "		 ####################################################$nc $blue v1$nc"
echo -e "	[+]             $red Author By TUAN DIPSEY           		   [+]"
echo -e "	[+] 		 $red www.facebook.com/tuan.dipsey$nc  		       [+]"
echo -e "	[+] 		 $red Greetz To All Pentesters$nc          		   [+]"
echo -e "	[+]$red Special Greetz To$nc :$green {SULAWESI CYBER ARMY & KAKARLAK TEAM}$nc [+]"
echo ""
echo -e "$yellow Select From Menu : $nc"
echo ""
echo -e "		$Cyan 1 : Brute Force Facebook$nc"
echo -e "		$Cyan 2 : Brute Force Gmail$nc"
echo -e "		$Cyan 3 : Brute Force Instagram$nc"
echo -e "		$Cyan 4 : Brute Force Twitter$nc"
